...
@Component({
  ...
  templateUrl: './updatedisjob.component.html',
  styleUrls: ['./updatedisjob.component.css']
})
export class UpdatedisjobComponent implements OnInit {
  jobForm!: FormGroup;
  jobid!: string | null;
  ...
  updateJob() {
    ...
    this.http.put(`${this.backend_URL}jobpostupdatedis/${this.jobid}`, formData)
      .subscribe(
       {
        next: (response:any) => {
